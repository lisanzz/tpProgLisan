...
namespace CineCordobaFront.Presentacion
{
    public partial class FrmModificarCliente : Form
    {
        ...
        {
            string url = "https://localhost:7163/clienteSegunId?id_cliente=" + "?idCliente=" + idCliente.ToString();
        ...
        public async Task CargarCampos()
        {
            ...
            if (oCliente != null)
            {
                ...
                cboBarrio.SelectedIndex = Convert.ToInt32(oCliente.BarrioId.ToString()) - 1;
                cboTipoDocumento.SelectedIndex = Convert.ToInt32(oCliente.TipoDocId.ToString()) - 1;
            }
            else
            {
        ...
        {
            string url = "https://localhost:7163/barrios";
            var data = await ClienteSingleton.ObtenerInstancia().GetAsync(url);
                    ...
                    {
                        {
                            ...
                            oCliente.ClienteId =Convert.ToInt32(id_cliente);
                            ...
                            oCliente.BarrioId = Convert.ToInt32(cboBarrio.SelectedValue);
                            oCliente.Calle = txtCalle.Text;
                            oCliente.Altura = Convert.ToInt32(txtAltura.Text);
                            oCliente.TipoDocId = Convert.ToInt32(cboTipoDocumento.SelectedValue);
