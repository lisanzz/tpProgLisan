...
namespace CineCordobaBack.Fachada.Implementacion
{
    public class ClienteDao : IClienteDao
    {
        ...
        public List<Clientes> ConsultarClientes()
        {
            ...
            {
                int id_cliente = Convert.ToInt32(fila[0]);
                ...
                Clientes c = new Clientes(id_cliente,nombre,apellido,fecha_nac, telefono,email,calle,altura,nro_doc);
                lstc.Add(c);
            }
        ...
        public Clientes ConsultarClientesId(int idCliente)
        {
            ...
            {
                Clientesq.ClienteId = Convert.ToInt32(dr["id_cliente"].ToString());
                ...
                Clientesq.BarrioId = Convert.ToInt32(dr["id_barrio"].ToString());
                Clientesq.Calle = dr["calle"].ToString();
                Clientesq.Altura = Convert.ToInt32(dr["altura"].ToString());
                Clientesq.TipoDocId = Convert.ToInt32(dr["id_tipo_doc"].ToString());
        ...
        public bool ModificarClientes(Clientes clientes)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@id_cliente", clientes.ClienteId);
                    ...
                    cmd.Parameters.AddWithValue("@id_barrio", clientes.BarrioId);
                    cmd.Parameters.AddWithValue("@calle", clientes.Calle);
                    cmd.Parameters.AddWithValue("@altura", clientes.Altura);
                    cmd.Parameters.AddWithValue("@id_tipo_doc", clientes.TipoDocId);
